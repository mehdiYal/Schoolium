...
class Admin extends \AppBundle\Entity\Admin implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'typeUser', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'photo', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'prenom', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'genre', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'dateDeNaissance', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'lieuDeNaissance', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'cIN', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'adresse', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'codePostal', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'telephone', '' . "\0" . 'AppBundle\\Entity\\Admin' . "\0" . 'commentaire', 'id', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
