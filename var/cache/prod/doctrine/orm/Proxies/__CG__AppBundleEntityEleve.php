 ...
 */
class Eleve extends \AppBundle\Entity\Eleve implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function setEcoleID($ecoleID)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEcoleID', [$ecoleID]);

        return parent::setEcoleID($ecoleID);
    }
    ...
    public function getEcoleID()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEcoleID', []);

        return parent::getEcoleID();
    }
