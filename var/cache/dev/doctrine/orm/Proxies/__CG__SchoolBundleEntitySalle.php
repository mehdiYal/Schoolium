 ...
 */
class Salle extends \SchoolBundle\Entity\Salle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SchoolBundle\\Entity\\Salle' . "\0" . 'ecole', '' . "\0" . 'SchoolBundle\\Entity\\Salle' . "\0" . 'id', '' . "\0" . 'SchoolBundle\\Entity\\Salle' . "\0" . 'nom', '' . "\0" . 'SchoolBundle\\Entity\\Salle' . "\0" . 'capacite', '' . "\0" . 'SchoolBundle\\Entity\\Salle' . "\0" . 'equipement'];
        }
