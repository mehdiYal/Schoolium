 ...
 */
class Evaluation extends \SchoolBundle\Entity\Evaluation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SchoolBundle\\Entity\\Evaluation' . "\0" . 'notes', '' . "\0" . 'SchoolBundle\\Entity\\Evaluation' . "\0" . 'evaluations', '' . "\0" . 'SchoolBundle\\Entity\\Evaluation' . "\0" . 'id', '' . "\0" . 'SchoolBundle\\Entity\\Evaluation' . "\0" . 'nom'];
        }
