 ...
 */
class Enseignant extends \AppBundle\Entity\Enseignant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'isResponsable', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'matsEns', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'ecole', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'typeUser', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'photo', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'prenom', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'genre', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'dateDeNaissance', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'dateDEntree', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'lieuDeNaissance', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'cIN', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'adresse', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'codePostal', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'telephone', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'typeContrat', '' . "\0" . 'AppBundle\\Entity\\Enseignant' . "\0" . 'commentaire', 'id', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setDateDEntree($dateDEntree)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateDEntree', [$dateDEntree]);

        return parent::setDateDEntree($dateDEntree);
    }
    ...
    public function getDateDEntree()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateDEntree', []);

        return parent::getDateDEntree();
    }
    ...
    public function setLieuDeNaissance($lieuDeNaissance)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLieuDeNaissance', [$lieuDeNaissance]);
    ...
    public function addIsResponsable(\SchoolBundle\Entity\Classe $isResponsable)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addIsResponsable', [$isResponsable]);

        return parent::addIsResponsable($isResponsable);
    }
    ...
    public function removeIsResponsable(\SchoolBundle\Entity\Classe $isResponsable)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeIsResponsable', [$isResponsable]);

        return parent::removeIsResponsable($isResponsable);
    }
    ...
    public function getIsResponsable()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsResponsable', []);

        return parent::getIsResponsable();
    }
    ...
    public function addMatsEn(\SchoolBundle\Entity\EnsMat $matsEn)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addMatsEn', [$matsEn]);

        return parent::addMatsEn($matsEn);
    }
    ...
    public function removeMatsEn(\SchoolBundle\Entity\EnsMat $matsEn)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeMatsEn', [$matsEn]);

        return parent::removeMatsEn($matsEn);
    }
    ...
    public function getMatsEns()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMatsEns', []);

        return parent::getMatsEns();
    }
