...
class Annee extends \SchoolBundle\Entity\Annee implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SchoolBundle\\Entity\\Annee' . "\0" . 'id', '' . "\0" . 'SchoolBundle\\Entity\\Annee' . "\0" . 'nom', '' . "\0" . 'SchoolBundle\\Entity\\Annee' . "\0" . 'niveau', '' . "\0" . 'SchoolBundle\\Entity\\Annee' . "\0" . 'specialite'];
        }
