...
class Eleve extends User
{
     ...
     * @var Parental
     *
     * @Assert\Type(type="UserBundle\Entity\Parental")
     *
     * @Assert\Valid()
     *
     ...
     * @return Eleve
     */
    public function setParent(\UserBundle\Entity\Parental $parent)
    {
        $this->parent = $parent;
     ...
     * Get parent
     *
     * @return \UserBundle\Entity\Parental
     */
     ...
     * Add retard
     *
     * @param \UserBundle\Entity\Retard $retard
     *
     * @return Eleve
     */
    public function addRetard(\UserBundle\Entity\Retard $retard)
    {
        $this->retards[] = $retard;
     ...
     * @param \UserBundle\Entity\Retard $retard
     */
    public function removeRetard(\UserBundle\Entity\Retard $retard)
    {
     ...
     * Add absence
     *
     * @param \UserBundle\Entity\Absence $absence
     *
     * @return Eleve
     */
    public function addAbsence(\UserBundle\Entity\Absence $absence)
    {
     ...
     * @param \UserBundle\Entity\Absence $absence
     */
    public function removeAbsence(\UserBundle\Entity\Absence $absence)
    {
     ...
     * Add note
     *
     * @param \UserBundle\Entity\Eleve $note
     *
     * @return Eleve
     */
    public function addNote(\UserBundle\Entity\Eleve $note)
    {
        $this->notes[] = $note;
     ...
     * @param \UserBundle\Entity\Eleve $note
     */
    public function removeNote(\UserBundle\Entity\Eleve $note)
    {
